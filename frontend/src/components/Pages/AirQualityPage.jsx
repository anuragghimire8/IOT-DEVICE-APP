...
const AirQualityPage = () => {
  ...
  // Narrower AQI category ranges
  const aqiCounts = {
    good: airQualityData.filter((d) => d.air_quality <= 1.5).length,
    moderate: airQualityData.filter((d) => d.air_quality > 1.5 && d.air_quality <= 3).length,
    unhealthy: airQualityData.filter((d) => d.air_quality > 3 && d.air_quality <= 5).length,
    veryUnhealthy: airQualityData.filter((d) => d.air_quality > 5 && d.air_quality <= 7).length,
    hazardous: airQualityData.filter((d) => d.air_quality > 7).length,
  };
